...
VALUES
  (
    ...
    'auth',
    'EIP Access',
    (SELECT COALESCE(MAX(version), 0) + 1 FROM eip_core.ui_surface WHERE tenant_id IS NULL AND code = 'auth'),
    true,
    true,
    true,
    $${
  ...
  "props": {
    ...
    "helper": "Organisation-first access with step-up verification."
  },
  "children": [
    {
      "id": "auth-hero",
      ...
      "props": {
        ...
        "subtitle": "Choose your organisation and authenticate with OTP or TOTP. System admins use organisation EIP.",
        "badges": ["Organisation isolation", "Trusted device policy", "Step-up required"],
        "metrics": [
          { "label": "Avg. OTP latency", "value": "38ms" },
          { "label": "Active organisations", "value": "260" },
      ...
      "children": [
        {
          ...
          "props": {
            "title": "Welcome back",
            "subtitle": "Sign in to your organisation. Step-up required for sensitive actions.",
            "fields": [
            ...
            "footnote": "Trusted device required for password-only login. OTP required for new devices."
          }
        },
        {
          "id": "feature-grid",
          ...
          "props": {
            "items": [
              { "title": "Session assurance", "desc": "High assurance sessions after OTP / TOTP verification." },
              { "title": "Organisation isolation", "desc": "Row-level enforcement and audited cross-surface access." },
              { "title": "Device trust", "desc": "Trusted devices required for password-only login." }
            ]
          }
        },
        {
          ...
          "props": {
            ...
            "points": [
              "Step-up required for auth/password/set, device trust, and admin actions.",
              "All sessions carry CSRF hashes and secure cookie attributes.",
    ...
    },
    {
      ...
      "props": {
        ...
        "subtitle": "Request a recovery link for EIP admin access.",

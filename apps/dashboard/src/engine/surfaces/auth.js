    ...
    children: [
      {
        ...
        props: {
          ...
          subtitle:
            "Secure access to your workspace. Enter your email, select your organisation, and authenticate with OTP or TOTP."
        }
      },
      {
        id: "auth-panels",
              ...
              items: [
                {
                  ...
                  desc: "Verified sign-ins maintain a secure and consistent session."
                },
                {
                  title: "Cross-site verification",
                  desc: "Verification checks are enforced across connected access points."
                },
                {
                  title: "Device trust",
                  desc: "Recognized devices improve sign-in continuity while preserving control."
                }
              ]
            }
          },
        ...
        props: {
          ...
          fields: [
            ...
            { key: "timezone", label: "Timezone", placeholder: "America/New_York" },
            {
              ...
              type: "terms",
              content:
                "By submitting this request, you confirm the information is accurate, agree to comply with EIP security policies, and acknowledge that access is subject to approval and contractual agreement. Full terms will be provided for signature during onboarding."
            },

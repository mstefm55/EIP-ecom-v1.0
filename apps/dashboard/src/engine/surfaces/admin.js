...
const dbExplorerLayout = {
  title: "Data explorer",
  subtitle:
    "Inspect schema metadata, review table rows, and export snapshots for analysis.",
  schema: {
    ...
    children: [
      {
        ...
        props: {
          ...
          title: "Admin console",
          subtitle:
            "Manage onboarding, security, audit, and tenant operations from a single control plane.",
      ...
      },
      {
        id: "tenant-panel",
        type: "AdminPanel",
        props: { tab: "tenant-requests" },
        children: [
          {
            id: "tenant-metrics",
            type: "AdminMetrics",
            props: { endpoint: "/api/eip/admin/tenant-requests" },
          },
          {
            id: "tenant-requests",
        ...
        children: [
          {
            ...
            props: { layout: processBuilderLayout }
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            props: { endpoint: "/api/eip/auth/devices" },
          },
        ],
      },
      {
      ...
      },
      {
        ...
        type: "AdminPanel",
        props: { tab: "data-explorer" },
        children: [
          {
            id: "db-explorer",
            type: "AdminDbExplorer",
            props: { layout: dbExplorerLayout }
          }
        ]
      },
      {
        ...
        children: [
          {
            ...
            props: { endpoint: "/api/eip/admin/monitoring" },
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            props: { layout: templateCloneLayout },
          },
        ],
      },
      {

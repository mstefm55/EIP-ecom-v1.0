...
export default function ArOverlayVisualizer() {
  const arMetadata = localizeMetadataTree(
    perfectFitMetadata.componentUi.arOverlayVisualizer,
    'component.arOverlayVisualizer',
    pfUiT
  );
  const MODEL_PRESETS = arMetadata.modelPresets;
  const OVERLAY_BLUEPRINTS = arMetadata.overlayBlueprints;
  const PRESETS = arMetadata.presets;
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-4 border-b border-sand-200/60 pb-5" id="ar-header">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-mono font-bold text-clay-550 uppercase tracking-[0.2em] bg-clay-50 border border-clay-100 px-2 py-0.5 rounded-[4px]">{pfUiT("ui.components.aroverlayvisualizer.e7409170d0")}</span>
          ...
          <h3 className="text-xl font-serif font-bold text-bark-950 tracking-tight flex items-center gap-2">
            <Layers className="w-5 h-5 text-clay-605" />{pfUiT("ui.components.aroverlayvisualizer.ca5ceb1e96")}</h3>
          <p className="text-xs text-bark-600 max-w-2xl leading-relaxed">{pfUiT("ui.components.aroverlayvisualizer.a8e3eee7c9")}</p>
        </div>
        <button
          ...
          id="ar-help-btn"
        >
          <HelpCircle className="w-3.5 h-3.5 text-clay-500" />{pfUiT("ui.components.aroverlayvisualizer.6b9d7d0074")}</button>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start" id="ar-main-layout">
        ...
        <div className="xl:col-span-6 flex flex-col space-y-4" id="ar-preview-column">
          <div className="flex justify-between items-center bg-sand-50/60 p-2.5 rounded-[4px] border border-sand-200/80">
            <span className="text-[10px] font-mono text-bark-500 font-bold uppercase tracking-wider">{pfUiT("ui.components.aroverlayvisualizer.f3b854d6f9")}</span>
            <div className="flex gap-2">
              <button
                ...
                title={pfUiT("ui.components.aroverlayvisualizer.267b52a748")}
              >
              ...
              <button
                ...
                title={pfUiT("ui.components.aroverlayvisualizer.d0319d0896")}
              >
                <RotateCcw className="w-3 h-3 text-bark-500" />{pfUiT("ui.components.aroverlayvisualizer.d5dd5a012d")}</button>
            </div>
          </div>
          ...
          >
            ...
            <img
              ...
              alt={pfUiT("ui.components.aroverlayvisualizer.ce4960d46a")}
            ...
            {showOverlayOnly && (
              <div className="absolute top-3 right-4 z-15 font-mono text-[8px] tracking-widest uppercase font-bold text-white bg-clay-700 px-2.5 py-1 rounded-[3px] shadow-sm">{pfUiT("ui.components.aroverlayvisualizer.55b734d273")}</div>
            )}
          </div>
        ...
        <div className="xl:col-span-6 space-y-5" id="ar-control-column">
          ...
          <div className="bg-[#FAF8F5] border border-sand-200/80 p-5 rounded-[4px] space-y-4">
            <span className="text-[10.5px] font-mono font-black text-clay-700 tracking-widest uppercase block border-b border-sand-200/60 pb-1.5">{pfUiT("ui.components.aroverlayvisualizer.ab6362dae5")}</span>
            ...
            {!userPhoto ? (
              ...
              >
                ...
                <div className="space-y-1">
                  <h5 className="text-xs font-bold text-bark-900 font-serif">{pfUiT("ui.components.aroverlayvisualizer.a21f66a188")}</h5>
              ...
              <div className="bg-white border border-sand-250 p-3 rounded-[4px] flex items-center justify-between shadow-3xs">
                ...
                <button
                  ...
                  title={pfUiT("ui.components.aroverlayvisualizer.bbb1ed769e")}
                >
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-[10px] font-mono font-bold text-bark-400 uppercase tracking-wider">
                <span>{pfUiT("ui.components.aroverlayvisualizer.9999fa8783")}</span>
                {userPhoto && <span className="text-clay-605">{pfUiT("ui.components.aroverlayvisualizer.9aacc2dc59")}</span>}
              </div>
          ...
          <div className="bg-[#FAF8F5] border border-sand-200/80 p-5 rounded-[4px] space-y-3.5">
            <span className="text-[10.5px] font-mono font-black text-clay-700 tracking-widest uppercase block border-b border-sand-200/60 pb-1.5">{pfUiT("ui.components.aroverlayvisualizer.b3ca1e971c")}</span>
          ...
          <div className="border border-sand-200/85 rounded-[4px] overflow-hidden bg-white shadow-3xs" id="ar-controls-tabs">
            ...
            <div className="flex border-b border-sand-200 bg-sand-50/40 font-mono text-[10.5px] font-bold uppercase tracking-widest">
              ...
              >
                <Sliders className="w-3 h-3 inline mr-1 text-clay-550" />{pfUiT("ui.components.aroverlayvisualizer.93c5d66f04")}</button>
              <button
              ...
              >
                <Layers className="w-3 h-3 inline mr-1 text-clay-550" />{pfUiT("ui.components.aroverlayvisualizer.65e69edc1d")}</button>
              <button
              ...
              >
                <Sparkles className="w-3 h-3 inline mr-1 text-clay-550" />{pfUiT("ui.components.aroverlayvisualizer.f27a7852f0")}</button>
            </div>
            ...
            {activeTab === 'templates' && (
              <div className="p-5 space-y-4 font-sans animate-fade-in">
                <div className="flex justify-between items-center text-[10px] font-mono text-bark-400 uppercase tracking-wider">
                  <span>{pfUiT("ui.components.aroverlayvisualizer.19ff0bbea0")}</span>
                  <button onClick={resetAlignment} className="text-clay-650 hover:underline">{pfUiT("ui.components.aroverlayvisualizer.53c7d90516")}</button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-xs text-bark-750">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between">
                      <span className="font-medium">{pfUiT("ui.components.aroverlayvisualizer.ffafe1f5b4")}</span>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between">
                      <span className="font-medium">{pfUiT("ui.components.aroverlayvisualizer.779ed39e45")}</span>
                ...
                <div className="border-l-2 border-clay-550 bg-clay-50/20 p-3 rounded-r-[4px] text-[11px] text-bark-650 leading-relaxed font-sans font-medium">
                  <strong>{pfUiT("ui.components.aroverlayvisualizer.04dba84d0e")}</strong>{pfUiT("ui.components.aroverlayvisualizer.31254f0676")}</div>
              </div>
            )}
            ...
            {activeTab === 'filters' && (
              <div className="p-5 space-y-5 animate-fade-in font-sans">
                <div className="flex justify-between items-center text-[10px] font-mono text-bark-400 uppercase tracking-wider">
                  <span>{pfUiT("ui.components.aroverlayvisualizer.68a070ce84")}</span>
                  <button onClick={resetFilters} className="text-clay-650 hover:underline">{pfUiT("ui.components.aroverlayvisualizer.a685926deb")}</button>
                </div>

                {/* Blend Mode Selection */}
                <div className="space-y-2">
                  <label className="text-xs font-serif font-black text-bark-900 block">{pfUiT("ui.components.aroverlayvisualizer.c0883d4369")}</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-xs text-bark-750">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between">
                      <span className="font-medium">{pfUiT("ui.components.aroverlayvisualizer.5ae53568ee")}</span>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between">
                      <span className="font-medium">{pfUiT("ui.components.aroverlayvisualizer.11fb447ead")}</span>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between">
                      <span className="font-medium">{pfUiT("ui.components.aroverlayvisualizer.c4afb88e8c")}</span>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between">
                      <span className="font-medium">{pfUiT("ui.components.aroverlayvisualizer.cd015bd692")}</span>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between">
                      <span className="font-medium">{pfUiT("ui.components.aroverlayvisualizer.d9695d1275")}</span>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between">
                      <span className="font-medium">{pfUiT("ui.components.aroverlayvisualizer.dc8657fbfd")}</span>
            ...
            {activeTab === 'presets' && (
              <div className="p-5 space-y-3.5 animate-fade-in font-sans">
                <span className="text-[10px] font-mono text-bark-400 uppercase tracking-wider block">{pfUiT("ui.components.aroverlayvisualizer.3cffc9c7fc")}</span>
        ...
        {isGuidelineModalOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative bg-white border border-sand-250 rounded-lg max-w-lg w-full p-6 shadow-2xl overflow-hidden text-bark-900"
            ...
            >
              <div className="flex justify-between items-start border-b border-sand-200 pb-3 mb-4">
                <h4 className="text-base font-serif font-bold text-bark-950 flex items-center gap-2">
                  <Scissors className="w-4 h-4 text-clay-605" />{pfUiT("ui.components.aroverlayvisualizer.45a2141432")}</h4>
                <button
              ...
              <div className="space-y-4 text-xs text-bark-700 leading-relaxed font-sans">
                <div className="space-y-1.5">
                  <strong className="text-bark-900 font-serif font-black uppercase text-[10px] tracking-wide block">{pfUiT("ui.components.aroverlayvisualizer.9a282fab2a")}</strong>
                  <p>{pfUiT("ui.components.aroverlayvisualizer.a47dcb1926")}</p>
                </div>

                <div className="space-y-1.5">
                  <strong className="text-bark-900 font-serif font-black uppercase text-[10px] tracking-wide block">{pfUiT("ui.components.aroverlayvisualizer.5cbbea4969")}</strong>
                  <ul className="list-disc list-inside space-y-1 pl-1 text-bark-650">
                    <li>{pfUiT("ui.components.aroverlayvisualizer.55fa8de2aa")}</li>
                    <li>{pfUiT("ui.components.aroverlayvisualizer.eadfc91064")}</li>
                    <li>{pfUiT("ui.components.aroverlayvisualizer.ac2d87117a")}</li>
                  </ul>
                </div>

                <div className="space-y-1.5">
                  <strong className="text-bark-900 font-serif font-black uppercase text-[10px] tracking-wide block">{pfUiT("ui.components.aroverlayvisualizer.7f142a8028")}</strong>
                  <p>{pfUiT("ui.components.aroverlayvisualizer.ab942dea50")}</p>
                </div>
              </div>
              ...
              <div className="border-t border-sand-200 pt-4 mt-5 flex justify-end">
                ...
                >{pfUiT("ui.components.aroverlayvisualizer.66ff592d98")}</button>
              </div>
            </motion.div>
          </div>
        )}

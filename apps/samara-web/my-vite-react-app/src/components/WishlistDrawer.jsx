      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-y-0 right-0 w-full max-w-md bg-[#FAF8F5] border-l border-sand-250 shadow-lux flex flex-col"
          ...
          >
            ...
            <div className="p-5 border-b border-sand-200/80 bg-white flex items-center justify-between" id="wishlist-header">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-serif font-bold text-bark-900 text-base leading-tight">{pfUiT("ui.components.wishlistdrawer.f8f11e0d6e")}</h3>
                  <p className="text-[10px] font-mono uppercase tracking-wider text-bark-450">{pfUiT("ui.components.wishlistdrawer.42e11a9661")}</p>
                </div>
              </div>
              <button
                onClick={onClose}
                ...
                type="button"
                aria-label={pfUiT("ui.components.wishlistdrawer.621feca563")}
              >
                <X className="w-4 h-4" />
              </button>
            </div>
              ...
              {favoritedPatterns.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-4" id="wishlist-empty-state">
                  ...
                  <div className="space-y-1.5">
                    <h4 className="font-serif font-semibold text-bark-900 text-sm">{pfUiT("ui.components.wishlistdrawer.5ad1114ff7")}</h4>
                    <p className="text-xs text-bark-500 max-w-xs leading-relaxed">{pfUiT("ui.components.wishlistdrawer.40a87c07f4")}</p>
                  </div>
                  <button
                    onClick={() => {
                      onClose();
                  ...
                  >
                    ...
                    <span>{pfUiT("ui.components.wishlistdrawer.8cfa1c2f4a")}</span>
                  </button>
                </div>
              ) : (
                <div className="space-y-3" id="wishlist-items-list">
                  <div className="flex justify-between items-center text-[10px] font-mono uppercase text-bark-400 font-bold px-1 pb-1 border-b border-sand-200/50">
                    <span>{pfUiT("ui.components.wishlistdrawer.797f67145a")}</span>
                    <span>{pfUiT("ui.components.wishlistdrawer.181e49f65b")}</span>
                  </div>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 min-w-0 flex-1">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5 text-[10px] text-bark-500 font-mono">
                              <span>{pfUiT("ui.components.wishlistdrawer.a3153bc6cf")}<strong className="text-bark-700 font-bold">{pattern.difficulty}</strong></span>
                              <span>•</span>
                        ...
                        <div className="flex items-center gap-1.5 shrink-0" id={`wishlist-actions-${pattern.id}`}>
                          <button
                            ...
                            title={pfUiT("ui.components.wishlistdrawer.012c770f96")}
                            type="button"
                          >
                          ...
                          <button
                            ...
                            title={pfUiT("ui.components.wishlistdrawer.99c398d95a")}
                            type="button"
                          >
                          ...
                          <button
                            ...
                            title={pfUiT("ui.components.wishlistdrawer.1842a62b6a")}
                            type="button"
                          >
            ...
            {favoritedPatterns.length > 0 && (
              <div className="border-t border-sand-200 p-5 bg-white space-y-3" id="wishlist-footer">
                <div className="flex justify-between items-center text-xs text-bark-600">
                  <span className="font-mono uppercase font-bold">{pfUiT("ui.components.wishlistdrawer.b971b38fd8")}</span>
                ...
                <button
                  ...
                  type="button"
                >
                  <span>{pfUiT("ui.components.wishlistdrawer.f4a7e22341")}</span>

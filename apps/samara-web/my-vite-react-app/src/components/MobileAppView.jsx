...
export default function MobileAppView({
  ...
  const handleMobileNewsletterSubmit = (e) => {
    ...
    if (mobileNewsEmail) {
      ...
      let currentSubs = [];
      try {
        const saved = runtimeDataStorage.getItem('perfectfit_newsletter_subscribers');
      ...
      if (!alreadySubscribed) {
        ...
        try {
          runtimeDataStorage.setItem('perfectfit_newsletter_subscribers', JSON.stringify(currentSubs));
        } catch (err) {}
      }
    ...
    <div className="flex flex-col h-full bg-[#FAF8F5] text-bark-900 select-none max-w-md mx-auto relative overflow-hidden font-sans border-x border-sand-200 shadow-2xl" id="mobile-app-shell">
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === 'catalog' && (
            ...
            >
              ...
              <div className="relative border border-sand-200 bg-white rounded-full flex items-center px-3 py-2 shadow-3xs">
                ...
                <input
                  type="text"
                  placeholder={pfUiT("ui.components.mobileappview.26f4871fbf")}
                  value={searchQuery}
              ...
              {filteredPatterns.length === 0 ? (
                <div className="text-center py-12 bg-white border border-sand-200 rounded-xl space-y-2">
                  ...
                  <h3 className="text-xs font-bold text-bark-900">{pfUiT("ui.components.mobileappview.aa6c0cd862")}</h3>
                  <p className="text-[10px] text-bark-500 max-w-xs mx-auto">{pfUiT("ui.components.mobileappview.d2601f9d1a")}</p>
                </div>
              ) : (
                <div className="space-y-4">
                      ...
                      >
                        ...
                        <div className="p-3 flex-1 flex flex-col justify-between min-w-0">
                          ...
                          <div className="flex justify-between items-center pt-2 border-t border-sand-100 mt-2">
                            <span className="text-[8.5px] font-mono text-bark-400">{pfUiT("ui.components.mobileappview.d5966020e6")}</span>
                            <span className="text-[9px] text-clay-650 font-bold uppercase tracking-wider flex items-center gap-0.5">{pfUiT("ui.components.mobileappview.93a604b277")}<ChevronRight className="w-3 h-3" />
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="bg-white border border-sand-200 rounded-xl p-3 space-y-3 shadow-3xs text-xs font-sans text-bark-800" id="mobile-pagination-section">
                    ...
                    <div className="flex items-center justify-between gap-1">
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          title={pfUiT("ui.components.mobileappview.4807752b80")}
                        >
                        ...
                        <button
                          ...
                          disabled={currentPage === 1}
                          className={`p-1.5 rounded-lg border border-sand-200 bg-sand-50/50 text-bark-600 cursor-pointer ${currentPage === 1 ? 'opacity-30 pointer-events-none' : 'hover:bg-sand-100 active:scale-95'}`}
                          title={pfUiT("ui.components.mobileappview.b2202c58c7")}
                        >
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          title={pfUiT("ui.components.mobileappview.f78084dc92")}
                        >
                        ...
                        <button
                          ...
                          disabled={currentPage === totalPages}
                          className={`p-1.5 rounded-lg border border-sand-200 bg-sand-50/50 text-bark-600 cursor-pointer ${currentPage === totalPages ? 'opacity-30 pointer-events-none' : 'hover:bg-sand-100 active:scale-95'}`}
                          title={pfUiT("ui.components.mobileappview.7eddcdfcb6")}
                        >
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-sand-150 text-[10px] text-bark-500">
                      ...
                      {/* Limit dropdown */}
                      <div className="flex items-center gap-1">
                        <span className="font-semibold uppercase tracking-wider text-[8.5px] text-bark-400">{pfUiT("ui.components.mobileappview.357d9bf8d7")}</span>
                        <select
                          value={itemsPerPage}
          ...
          {activeTab === 'fitting' && (
            ...
            >
              ...
              <div className="bg-[#FAF8F5] border border-sand-200/80 rounded-xl p-3 space-y-2 shadow-3xs">
                <div className="flex justify-between items-center">
                  <span className="text-[9px] text-clay-700 font-bold uppercase tracking-widest flex items-center gap-1">
                    <Sparkles className="w-3 h-3 text-clay-605" />{pfUiT("ui.components.mobileappview.3ffec4981a")}</span>
                ...
                <div className="grid grid-cols-3 gap-2 py-1.5 border-y border-sand-200/60 text-center bg-white/45 rounded-md">
                  <div className="space-y-0.5">
                    <span className="text-[8px] font-mono text-bark-400 uppercase tracking-widest block">{pfUiT("ui.components.mobileappview.f864670135")}</span>
                  ...
                  <div className="space-y-0.5 border-x border-sand-200/50">
                    <span className="text-[8px] font-mono text-bark-400 uppercase tracking-widest block">{pfUiT("ui.components.mobileappview.b2df33a126")}</span>
                    <span className="text-sm font-bold text-bark-900 font-mono">Size {recommendation.waistRec}</span>
                  </div>
                  <div className="space-y-0.5">
                    <span className="text-[8px] font-mono text-bark-400 uppercase tracking-widest block">{pfUiT("ui.components.mobileappview.0fa7b8d832")}</span>
              ...
              <div className="flex bg-sand-100/50 border border-sand-200 rounded-lg p-1 text-[10px] font-bold tracking-wider uppercase font-sans">
                ...
                >{pfUiT("ui.components.mobileappview.5b8c60423d")}</button>
                <button
                ...
                >{pfUiT("ui.components.mobileappview.1c8bc49f73")}</button>
                <button
                ...
                >{pfUiT("ui.components.mobileappview.e24884ae55")}</button>
              </div>
              ...
              <AnimatePresence mode="wait">
                ...
                {fittingSubTab === 'mannequin' && (
                  ...
                  >
                    <div className="bg-[#FAF8F5] border border-sand-200 rounded-xl p-4 flex flex-col items-center justify-center min-h-[360px] relative overflow-hidden bg-gradient-to-b from-[#fdfcfb] via-[#f7f4ef] to-[#eeeae2]">
                      ...
                      <span className="absolute bottom-2 text-[8px] font-mono text-bark-400 uppercase tracking-widest block bg-white/60 px-2 py-0.5 rounded-[4px]">{pfUiT("ui.components.mobileappview.731f1c702f")}</span>
                    </div>
                ...
                {fittingSubTab === 'metrics' && (
                  ...
                  >
                    <div className="space-y-0.5">
                      <h4 className="text-xs font-bold text-bark-900 uppercase tracking-widest font-serif">{pfUiT("ui.components.mobileappview.a21f85c0b7")}</h4>
                      <p className="text-[10px] text-bark-450">{pfUiT("ui.components.mobileappview.e222085bea")}</p>
                    </div>
                    ...
                    <div className="space-y-2 pt-2 divide-y divide-sand-100">
                      ...
                      <div className="flex items-center justify-between py-2 text-xs">
                        <div className="space-y-0.5">
                          <span className="font-bold text-bark-850">{pfUiT("ui.components.mobileappview.8c92f8f5b6")}</span>
                      ...
                      <div className="flex items-center justify-between py-2 text-xs">
                        <div className="space-y-0.5">
                          <span className="font-bold text-bark-850">{pfUiT("ui.components.mobileappview.ec9680601d")}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <input
                            type="number"
                      ...
                      <div className="flex items-center justify-between py-2 text-xs">
                        <div className="space-y-0.5">
                          <span className="font-bold text-bark-850">{pfUiT("ui.components.mobileappview.62df82abc1")}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <input
                            type="number"
                      ...
                      <div className="flex items-center justify-between py-2 text-xs">
                        <div className="space-y-0.5">
                          <span className="font-bold text-bark-850">{pfUiT("ui.components.mobileappview.4975a2c45f")}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <input
                            type="number"
                      ...
                      <div className="flex items-center justify-between py-2 text-xs">
                        <div className="space-y-0.5">
                          <span className="font-bold text-bark-850">{pfUiT("ui.components.mobileappview.239921d3ee")}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <input
                            type="number"
                      ...
                      <div className="flex items-center justify-between py-2 text-xs">
                        <div className="space-y-0.5">
                          <span className="font-bold text-bark-850">{pfUiT("ui.components.mobileappview.b9eeb9e776")}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <input
                            type="number"
                  ...
                  >
                    <div className="flex justify-between items-center border-b border-sand-150 pb-2">
                      <h4 className="text-xs font-bold text-bark-900 uppercase tracking-widest flex items-center gap-1.5">
                        <Cloud className="w-4 h-4 text-clay-605" />{pfUiT("ui.components.mobileappview.bc1adc5d71")}</h4>
                      {isSyncing && (
                    ...
                    {!isDriveConnected ? (
                      <div className="py-6 text-center space-y-3">
                        ...
                        <div className="space-y-1 px-2">
                          <h5 className="text-xs font-bold text-bark-900">{pfUiT("ui.components.mobileappview.ebc0bc2f73")}</h5>
                          <p className="text-[10px] text-bark-500 leading-normal">{pfUiT("ui.components.mobileappview.40a392971f")}</p>
                        </div>
                        <button
                        ...
                        >
                          <LogIn className="w-3.5 h-3.5" />{pfUiT("ui.components.mobileappview.c7edd60f45")}</button>
                      </div>
                    ) : (
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between bg-sand-50 p-2.5 rounded-lg border border-sand-200">
                          ...
                          >{pfUiT("ui.components.mobileappview.7c76bbcc68")}</button>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          >
                            <UploadCloud className="w-3.5 h-3.5" />{pfUiT("ui.components.mobileappview.81573b268d")}</button>
                          <button
                          ...
                          >
                            <FileText className="w-3.5 h-3.5 text-clay-605" />{pfUiT("ui.components.mobileappview.0ddf7c28ae")}</button>
                        </div>

                        {/* Backed up file list */}
                        <div className="space-y-1.5">
                          <div className="flex justify-between items-center text-[9px] font-mono text-bark-400 uppercase tracking-widest pt-1">
                            <span>{pfUiT("ui.components.mobileappview.c3a2e8e81b")}</span>
                            <button onClick={fetchDriveFiles} className="hover:text-bark-900 font-bold">{pfUiT("ui.components.mobileappview.b8ee7cc1aa")}</button>
                          </div>
                          ...
                          {isLoadingFiles ? (
                            ...
                            <p className="text-[10px] text-bark-400 italic text-center py-4 bg-sand-50/40 rounded-lg border border-dashed border-sand-200">{pfUiT("ui.components.mobileappview.4e4441d6be")}</p>
                          ) : (
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center gap-1 shrink-0">
                                      {isJson && (
                                        ...
                                        >{pfUiT("ui.components.mobileappview.620c9d79cd")}</button>
                                      )}
                                      <button
          ...
          {activeTab === 'academy' && (
            ...
            >
              ...
              <div className="space-y-1.5">
                <span className="text-[9px] text-clay-700 font-mono font-bold uppercase tracking-widest block">{pfUiT("ui.components.mobileappview.3f3204d631")}</span>
                <h3 className="text-xl font-serif text-bark-950 font-light">{pfUiT("ui.components.mobileappview.611bf3877c")}</h3>
                <p className="text-[10px] text-bark-550 leading-relaxed">{pfUiT("ui.components.mobileappview.7e5009ba88")}</p>
              </div>

              {/* Masterclass card 1 */}
              <div className="bg-white border border-sand-200 rounded-xl overflow-hidden p-3.5 space-y-3.5 shadow-3xs">
                <div className="flex justify-between items-start">
                  <span className="bg-clay-50 text-clay-705 text-[8.5px] font-mono font-bold px-2 py-0.5 border border-clay-100 rounded-full uppercase">{pfUiT("ui.components.mobileappview.36008d8111")}</span>
                  <span className="text-[9px] font-mono text-bark-405 font-bold">{pfUiT("ui.components.mobileappview.0012a87709")}</span>
                </div>
                <div className="space-y-1">
                  <h4 className="font-serif font-bold text-bark-900 text-sm">{pfUiT("ui.components.mobileappview.9cec33e228")}</h4>
                  <p className="text-[10.5px] text-bark-600 leading-normal">{pfUiT("ui.components.mobileappview.ad95e2a2e6")}</p>
                </div>
                <div className="flex justify-between items-center text-[10px] font-bold text-clay-650 pt-2 border-t border-sand-100">
                  <span>{pfUiT("ui.components.mobileappview.9ffd9d8ba7")}</span>
                  <ChevronRight className="w-3.5 h-3.5" />
                </div>
              </div>
              ...
              <div className="bg-white border border-sand-200 rounded-xl overflow-hidden p-3.5 space-y-3.5 shadow-3xs">
                <div className="flex justify-between items-start">
                  <span className="bg-sage-50 text-sage-750 text-[8.5px] font-mono font-bold px-2 py-0.5 border border-sage-100 rounded-full uppercase">{pfUiT("ui.components.mobileappview.2dd1d2083b")}</span>
                  <span className="text-[9px] font-mono text-bark-405 font-bold">{pfUiT("ui.components.mobileappview.e29a9ae984")}</span>
                </div>
                <div className="space-y-1">
                  <h4 className="font-serif font-bold text-bark-900 text-sm">Slash &amp; Spread Bodice Adjustments</h4>
                  <p className="text-[10.5px] text-bark-600 leading-normal">{pfUiT("ui.components.mobileappview.cc6583799a")}</p>
                </div>
                <div className="flex justify-between items-center text-[10px] font-bold text-clay-650 pt-2 border-t border-sand-100">
                  <span>{pfUiT("ui.components.mobileappview.9ffd9d8ba7")}</span>
                  <ChevronRight className="w-3.5 h-3.5" />
              ...
              <div className="bg-white border border-sand-200 rounded-xl overflow-hidden p-3.5 space-y-3.5 shadow-3xs">
                <div className="flex justify-between items-start">
                  <span className="bg-sand-100 text-bark-750 text-[8.5px] font-mono font-bold px-2 py-0.5 border border-sand-200 rounded-full uppercase">{pfUiT("ui.components.mobileappview.ad62561cea")}</span>
                  <span className="text-[9px] font-mono text-bark-405 font-bold font-semibold">{pfUiT("ui.components.mobileappview.faadb9c207")}</span>
                </div>
                <div className="space-y-1">
                  <h4 className="font-serif font-bold text-bark-900 text-sm">{pfUiT("ui.components.mobileappview.db031c29a7")}</h4>
                  <p className="text-[10.5px] text-bark-600 leading-normal">{pfUiT("ui.components.mobileappview.eca86375ab")}</p>
                </div>
                <div className="flex justify-between items-center text-[10px] font-bold text-clay-650 pt-2 border-t border-sand-100">
                  <span>{pfUiT("ui.components.mobileappview.9ffd9d8ba7")}</span>
                  <ChevronRight className="w-3.5 h-3.5" />
            ...
            >
              {currentUser ? (
                <div className="space-y-4">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <div className="pt-2 flex justify-center gap-2">
                        {currentUser.role === 'collaborator' ? (
                          <span className="text-[8.5px] px-2.5 py-0.5 bg-clay-50 border border-clay-100 rounded-full font-mono text-clay-705 uppercase font-bold">{pfUiT("ui.components.mobileappview.b5999daaa9")}</span>
                        ) : (
                          <span className="text-[8.5px] px-2.5 py-0.5 bg-sage-50 border border-sage-150 rounded-full font-mono text-sage-750 uppercase font-bold">{pfUiT("ui.components.mobileappview.1d6edbfa23")}</span>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white border border-sand-200 rounded-xl p-4 space-y-3 shadow-3xs">
                    <h4 className="text-xs font-bold text-bark-900 uppercase tracking-widest font-serif">{pfUiT("ui.components.mobileappview.62a64429ff")}</h4>
                    <div className="grid grid-cols-2 gap-3 text-xs">
                      <div className="p-2 bg-sand-50/50 rounded-md border border-sand-100">
                        <span className="text-[9px] text-bark-400 block font-mono">{pfUiT("ui.components.mobileappview.e0f042bc27")}</span>
                        <span className="font-bold text-bark-900">{bust} {unit}</span>
                      </div>
                      <div className="p-2 bg-sand-50/50 rounded-md border border-sand-100">
                        <span className="text-[9px] text-bark-400 block font-mono">{pfUiT("ui.components.mobileappview.b005b808f6")}</span>
                        <span className="font-bold text-bark-900">{waist} {unit}</span>
                      </div>
                      <div className="p-2 bg-sand-50/50 rounded-md border border-sand-100">
                        <span className="text-[9px] text-bark-400 block font-mono">{pfUiT("ui.components.mobileappview.8c0ce5d2eb")}</span>
                        <span className="font-bold text-bark-900">{hips} {unit}</span>
                      </div>
                      <div className="p-2 bg-sand-50/50 rounded-md border border-sand-100">
                        <span className="text-[9px] text-bark-400 block font-mono">{pfUiT("ui.components.mobileappview.56033f55bc")}</span>
                  ...
                  <div className="bg-[#FAF8F5] p-3 rounded-lg border border-sand-200 text-center">
                    <p className="text-[10px] text-bark-500 italic">{pfUiT("ui.components.mobileappview.c84e7aa8ea")}</p>
                  </div>
                </div>
              ) : (
                <div className="bg-white border border-sand-200 rounded-xl p-6 text-center space-y-4 shadow-3xs">
                  ...
                  <div className="space-y-1.5 px-2">
                    <h4 className="text-sm font-serif font-bold text-bark-900">{pfUiT("ui.components.mobileappview.83984e03e7")}</h4>
                    <p className="text-[11px] text-bark-500 leading-normal">{pfUiT("ui.components.mobileappview.c9b11459e4")}</p>
                  </div>
                  <button
                    onClick={onOpenAuthModal}
                  ...
                  >{pfUiT("ui.components.mobileappview.bfe2b09a33")}</button>
                </div>
              )}
              ...
              <div className="bg-bark-950 text-sand-50 rounded-xl p-5 space-y-3 shadow-sm" id="mobile-newsletter-card">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-xs font-serif font-bold uppercase tracking-widest text-sand-100">{pfUiT("ui.components.mobileappview.1c37c3b01b")}</h4>
                </div>
                <p className="text-[10px] text-sand-200 leading-relaxed">{pfUiT("ui.components.mobileappview.2c06e618c4")}</p>

                <form onSubmit={handleMobileNewsletterSubmit} className="flex gap-1.5 pt-1">
                  <input
                    type="email"
                    placeholder={pfUiT("ui.components.mobileappview.aa95b793c7")}
                ...
                {mobileNewsSubscribed && (
                  <p className="text-[10px] text-emerald-400 flex items-start gap-1 leading-normal transition-all duration-300 animate-fade-in pt-1" id="mobile-news-success">
                    ...
                    <span>{pfUiT("ui.components.mobileappview.d0a0d5f312")}<b className="text-amber-300 font-mono select-all">ARTISAN15</b>{pfUiT("ui.components.mobileappview.32c20d2fd8")}</span>
                  </p>
                )}
              </div>
            ...
            >
              <div className="bg-white border border-sand-200 rounded-xl p-3 shadow-3xs">
                <div className="flex items-center gap-2 pb-2.5 mb-2.5 border-b border-sand-100">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-bark-900 uppercase tracking-wider">{pfUiT("ui.components.mobileappview.b9a21cf76e")}</h3>
                    <p className="text-[10px] text-bark-450 leading-none">Industrial companion &amp; study tool</p>
                  </div>
                </div>

                <p className="text-[10.5px] text-bark-650 leading-relaxed">{pfUiT("ui.components.mobileappview.03342bea96")}</p>
              </div>
        ...
        {selectedPattern && (
          ...
          >
            ...
            <div className="px-4 py-3.5 border-b border-sand-200 flex items-center justify-between sticky top-0 bg-white z-10">
              ...
              >
                <ArrowLeft className="w-4 h-4" />{pfUiT("ui.components.mobileappview.9263314806")}</button>
              <h3 className="text-xs font-serif font-bold uppercase tracking-widest text-bark-900">{pfUiT("ui.components.mobileappview.1e1175b9cf")}</h3>
              <button
                onClick={() => setSelectedPattern(null)}
            ...
            <div className="flex-1 overflow-y-auto pb-24 p-4 space-y-4">
              ...
              <div className="flex border-b border-sand-200 text-xs font-semibold">
                ...
                >{pfUiT("ui.components.mobileappview.3f2d1b0acf")}</button>
                <button
                ...
                >{pfUiT("ui.components.mobileappview.b3b63e9d6f")}</button>
                <button
                ...
                >{pfUiT("ui.components.mobileappview.be01891f98")}</button>
              </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <h4 className="font-bold text-bark-900 flex items-center gap-1">
                        <Check className="w-3.5 h-3.5 text-clay-605" />{pfUiT("ui.components.mobileappview.dcc23c9863")}</h4>
                ...
                {detailTab === 'sizing' && (
                  <div className="space-y-4">
                    <div className="space-y-1.5 bg-sand-50/50 p-3 rounded-lg border border-sand-150">
                      <h4 className="font-bold text-bark-900 uppercase tracking-widest text-[10px] font-mono">{pfUiT("ui.components.mobileappview.28c2ce9150")}</h4>
                    ...
                    <div className="space-y-2 pt-1">
                      <h4 className="font-bold text-bark-900">{pfUiT("ui.components.mobileappview.e2f82222fe")}</h4>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {(reviews[selectedPattern.id] || []).length === 0 ? (
                        <p className="text-bark-500 italic text-center py-4 text-[11px]">{pfUiT("ui.components.mobileappview.63e1d0161d")}</p>
                      ) : (
                    ...
                    <form onSubmit={(e) => handleSubmitReview(e, selectedPattern.id)} className="bg-sand-100/30 border border-sand-200 p-3.5 rounded-lg space-y-3">
                      <h4 className="font-serif font-semibold text-bark-900 text-xs">{pfUiT("ui.components.mobileappview.55ba8ec4df")}</h4>
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div className="space-y-1">
                          <label className="text-[9.5px] font-semibold text-bark-500 uppercase block pl-0.5">{pfUiT("ui.components.mobileappview.cbb5c3944d")}</label>
                          <input
                            type="text"
                            required
                            value={newReviewName}
                            ...
                            placeholder={pfUiT("ui.components.mobileappview.c40dc9b994")}
                          />
                        </div>
                        <div className="space-y-1">
                          <label className="text-[9.5px] font-semibold text-bark-500 uppercase block pl-0.5">{pfUiT("ui.components.mobileappview.19a8e49729")}</label>
                          <select
                      ...
                      <div className="space-y-1 text-xs">
                        <label className="text-[9.5px] font-semibold text-bark-500 uppercase block pl-0.5">{pfUiT("ui.components.mobileappview.64b9b2ffdf")}</label>
                        <input
                          type="text"
                          required
                          ...
                          placeholder={pfUiT("ui.components.mobileappview.8446641c27")}
                        />
                      </div>

                      <div className="space-y-1 text-xs">
                        <label className="text-[9.5px] font-semibold text-bark-500 uppercase block pl-0.5">{pfUiT("ui.components.mobileappview.b3b5d0e4a6")}</label>
                        <textarea
                          required
                          ...
                          rows="2"
                          className="w-full bg-white border border-sand-200 rounded p-1.5"
                          placeholder={pfUiT("ui.components.mobileappview.894bda0e0b")}
                        />
                      </div>
                      ...
                      >{pfUiT("ui.components.mobileappview.6ba326a8d4")}</button>
                    </form>
                  </div>
                )}
              </div>
            ...
            <div className="p-3 border-t border-sand-200 bg-[#FAF8F5] flex items-center justify-between gap-3 absolute bottom-0 left-0 right-0 z-25">
              <div className="flex flex-col">
                <span className="text-[8.5px] font-mono text-bark-400 uppercase tracking-wider">{pfUiT("ui.components.mobileappview.d9f4f581f9")}</span>
              ...
              <div className="flex gap-1.5 flex-1 max-w-[280px]">
                ...
                >{pfUiT("ui.components.mobileappview.4bf08950d0")}</button>
                <button
                  onClick={() => {
                  ...
                  title={pfUiT("ui.components.mobileappview.20a8a7d381")}
                >{pfUiT("ui.components.mobileappview.359e1d1834")}</button>
              </div>
            </div>
          </motion.div>
        )}
            ...
            >
              ...
              <div className="p-4 border-b border-sand-200 flex items-center justify-between">
                <h3 className="font-serif font-bold text-sm uppercase tracking-wider text-bark-900 flex items-center gap-2">
                  <ShoppingBag className="w-4 h-4 text-clay-605" />{pfUiT("ui.components.mobileappview.cbd06d017a")}</h3>
                <button
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                {cartItems.length === 0 ? (
                  <div className="py-20 text-center space-y-2">
                    ...
                    <p className="text-xs text-bark-500 italic">{pfUiT("ui.components.mobileappview.9a4212fe01")}</p>
                  </div>
                ) : (
                  cartItems.map((item) => (
                    <div
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 space-y-1">
                        ...
                        <p className="text-[9px] text-bark-450 uppercase font-mono block">{pfUiT("ui.components.mobileappview.986c9c3016")}<b>{item.format}</b> &bull; Size {item.sizePreference}
                        </p>
                        ...
                        <div className="flex justify-between items-center pt-1">
                          ...
                          >
                            <Trash2 className="w-3 h-3 text-clay-605" />{pfUiT("ui.components.mobileappview.4837fb50d4")}</button>
                        </div>
                      </div>
                    </div>
                  ))
              ...
              {cartItems.length > 0 && (
                <div className="p-4 border-t border-sand-200 bg-[#FAF8F5] space-y-3">
                  <div className="flex justify-between items-center text-xs font-bold text-bark-900">
                    <span>{pfUiT("ui.components.mobileappview.ab35034098")}</span>
                    <span className="font-mono text-clay-750">${totalCartValue.toFixed(2)}</span>
                  </div>
                  <p className="text-[8.5px] text-bark-450 italic leading-normal">{pfUiT("ui.components.mobileappview.3c9ef1b2ab")}</p>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-center text-[10px] font-bold">
                    ...
                    >{pfUiT("ui.components.mobileappview.7316fbe79e")}</button>
                    <button
                      onClick={() => {
                    ...
                    >{pfUiT("ui.components.mobileappview.35e6c79783")}</button>
                  </div>
                </div>
              )}
            </motion.div>
      ...
      <nav className="absolute bottom-0 left-0 right-0 h-16 border-t border-sand-200 bg-white flex items-center justify-around z-20 shadow-lg">
        ...
        >
          ...
          <span className="text-[9.5px] font-sans">{pfUiT("ui.components.mobileappview.bf629b56f2")}</span>
        </button>
        ...
        >
          ...
          <span className="text-[9.5px] font-sans">{pfUiT("ui.components.mobileappview.36e26aaaff")}</span>
        </button>
        ...
        >
          ...
          <span className="text-[9.5px] font-sans">{pfUiT("ui.components.mobileappview.731e8619ce")}</span>
        </button>
        ...
        >
          ...
          <span className="text-[9.5px] font-sans">{pfUiT("ui.components.mobileappview.5248471db0")}</span>
        </button>
        ...
        >
          ...
          <span className="text-[9.5px] font-sans">{pfUiT("ui.components.mobileappview.8e32259cce")}</span>
        </button>
      </nav>

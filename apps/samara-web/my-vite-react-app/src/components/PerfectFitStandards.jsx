  ...
  return (
    <section className="bg-white rounded-[4px] border border-sand-200 p-8 md:p-12 space-y-10 shadow-lux relative overflow-hidden" id="perfect-fit-specification-guide">
      ...
      <motion.div
        ...
        id="handguide-header"
      >
        <h2 className="text-3xl md:text-4xl font-serif text-bark-950 font-light leading-[1.12]" id="handguide-title">{pfUiT("ui.components.perfectfitstandards.6d20c23427")}</h2>
        <p className="text-xs sm:text-sm text-bark-550 leading-relaxed font-sans max-w-lg mx-auto" id="handguide-text">{pfUiT("ui.components.perfectfitstandards.8df0389f1b")}</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10" id="bento-grid">
        ...
        >
          ...
          <div className="pt-2 border-t border-sand-150/40 text-[10px] font-mono text-clay-700 font-bold tracking-wider uppercase flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">{pfUiT("ui.components.perfectfitstandards.5583a121a2")}<span>→</span>
          </div>
        </motion.div>
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-xs text-bark-600 leading-relaxed font-sans">{pfUiT("ui.components.perfectfitstandards.27882bd5cf")}</p>
          </div>
          <div className="pt-2 border-t border-sand-150/40 text-[10px] font-mono text-clay-700 font-bold tracking-wider uppercase flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">{pfUiT("ui.components.perfectfitstandards.dbea75738c")}<span>→</span>
          </div>
        </motion.div>
        ...
        >
          <div className="space-y-4">
            ...
            <h4 className="font-serif font-semibold text-bark-900 text-lg group-hover:text-clay-605 transition-colors">{pfUiT("ui.components.perfectfitstandards.57af246166")}</h4>
            <p className="text-xs text-bark-600 leading-relaxed font-sans">{pfUiT("ui.components.perfectfitstandards.d95b4c7bb2")}</p>
          </div>
          <div className="pt-2 border-t border-sand-150/40 text-[10px] font-mono text-clay-700 font-bold tracking-wider uppercase flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">{pfUiT("ui.components.perfectfitstandards.168040e7b0")}<span>→</span>
          </div>
        </motion.div>
      </div>
    </section>

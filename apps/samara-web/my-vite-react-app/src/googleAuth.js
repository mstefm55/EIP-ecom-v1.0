...
const GOOGLE_DRIVE_UI = localizeMetadataTree(perfectFitMetadata.componentUi.googleDriveIntegration, 'component.googleDriveIntegration');
...
export const saveJsonToDrive = async (jsonData, filename) => {
  ...
  const metadata = {
    ...
    description: GOOGLE_DRIVE_UI.measurementsLedgerDescription,
  };
...
export const saveTextToDrive = async (textContent, filename) => {
  ...
  const metadata = {
    ...
    description: GOOGLE_DRIVE_UI.patternSizingReportDescription,
  };

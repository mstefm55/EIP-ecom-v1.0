  ...
  return (
    <section className="bg-white rounded-[4px] border border-sand-200 p-6 md:p-10 space-y-8 shadow-lux relative overflow-hidden text-left" id="perfect-fit-faq-section">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-3 relative z-10" id="faq-header">
        ...
        <p className="text-xs text-bark-550 max-w-lg mx-auto" id="faq-desc">
          Get instant professional answers about premium fabric handling, digital printing calibration standards, and global shipping parameters.
        </p>
      </div>
        ...
        <div className="lg:col-span-4 space-y-6" id="faq-sidebar">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search drapery, A0, tracking..."
                value={searchQuery}
            ...
            <div className="flex flex-col gap-1.5" id="faq-categories-container">
              ...
              >
                <span className="flex items-center gap-2">
                  <BookOpen className="w-3.5 h-3.5 text-bark-500" /> All Curated Topics
                </span>
              ...
              >
                <span className="flex items-center gap-2">
                  <Printer className="w-3.5 h-3.5 text-[#e0a894]" /> Digital Pattern Printing
                </span>
                <span className="text-[9px] font-mono bg-sand-100 px-1.5 py-0.2 rounded font-bold">
          ...
          <div className="bg-sand-50/40 border border-sand-200 rounded p-4 space-y-2">
            <div className="flex items-center gap-2 text-[10px] font-mono font-bold text-clay-700 uppercase tracking-widest">
              <Sparkles className="w-3.5 h-3.5" /> Tailor's Golden Rule
            </div>
            <p className="text-[10.5px] text-bark-550 leading-relaxed font-sans">
              "Measure twice, print once." Always print only the first page containing the calibration block before rolling out the full layout to save precious fibers and inks.
            </p>
          </div>
          ...
          <div className="bg-sand-50/35 border border-sand-200 rounded-[4px] p-5 space-y-4" id="faq-custom-form-container">
            <div className="space-y-1">
              <h4 className="text-sm font-serif font-semibold text-bark-900 flex items-center gap-2">
                <MessageSquare className="w-4 h-4 text-clay-605" /> Ask Our Perfect Fit Specialists
              </h4>
              <p className="text-[10.5px] text-bark-550">
                Can't find the exact technical answer? Submit your custom fabric drape or printing calibration inquiry.
              </p>
            </div>
            ...
            <form onSubmit={handleCustomQuestionSubmit} className="space-y-3" id="faq-custom-form">
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
                ...
                <div className="sm:col-span-4 space-y-1">
                  <label className="text-[9px] font-mono font-bold text-bark-500 uppercase tracking-wider block">
                    Garment Topic
                  </label>
                  <select
                  ...
                  >
                    <option value="fabric">Fabric Weights</option>
                    <option value="printing">PDF Printing</option>
                ...
                <div className="sm:col-span-8 space-y-1">
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      required
                      placeholder="e.g. Can I use stretch denim for the Trench Coat pattern?"
              ...
              {submitSuccess && (
                ...
                >
                  ...
                  <span>Success! Your custom inquiry has been loaded into your local view and is awaiting review.</span>
                </motion.div>
              )}
            </form>
          </div>

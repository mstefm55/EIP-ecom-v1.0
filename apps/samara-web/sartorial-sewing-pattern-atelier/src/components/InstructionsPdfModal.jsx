...
export default function InstructionsPdfModal({ isOpen, onClose, pattern }) {
  ...
  // Pattern Piece List for dynamic rendering in Layout Diagram
  const getPatternPieces = () => {
    switch (pattern.category) {
      case 'Dresses':
        return [
          { name: 'Front Bodice', count: 'Cut 1 on Fold', size: 'w-[40%] h-[35%]', x: 'left-4 top-4' },
          { name: 'Back Bodice', count: 'Cut 2', size: 'w-[25%] h-[35%]', x: 'left-[46%] top-4' },
          { name: 'Skirt Front', count: 'Cut 1 on Fold', size: 'w-[50%] h-[45%]', x: 'left-4 bottom-4' },
          { name: 'Skirt Back', count: 'Cut 2', size: 'w-[35%] h-[45%]', x: 'left-[56%] bottom-4' }
        ];
      case 'Outerwear':
        return [
          { name: 'Coat Front', count: 'Cut 2', size: 'w-[30%] h-[60%]', x: 'left-4 top-4' },
          { name: 'Coat Back', count: 'Cut 1 on Fold', size: 'w-[35%] h-[60%]', x: 'left-[36%] top-4' },
          { name: 'Sleeve', count: 'Cut 2', size: 'w-[25%] h-[45%]', x: 'right-4 top-4' },
          { name: 'Storm Flap', count: 'Cut 2 Collar', size: 'w-[20%] h-[20%]', x: 'right-4 bottom-4' }
        ];
      case 'Trousers':
        return [
          { name: 'Pant Front', count: 'Cut 2', size: 'w-[35%] h-[75%]', x: 'left-6 top-6' },
          { name: 'Pant Back', count: 'Cut 2', size: 'w-[40%] h-[75%]', x: 'left-[45%] top-6' },
          { name: 'Waistband', count: 'Cut 1 Interfaced', size: 'w-[80%] h-[12%]', x: 'left-6 bottom-4' }
        ];
      default:
        return [
          { name: 'Front Panel', count: 'Cut 1 on Fold', size: 'w-[45%] h-[45%]', x: 'left-4 top-4' },
          { name: 'Back Panel', count: 'Cut 2', size: 'w-[40%] h-[45%]', x: 'left-[52%] top-4' },
          { name: 'Sleeve / Facing', count: 'Cut 2', size: 'w-[30%] h-[35%]', x: 'left-4 bottom-4' }
        ];
    }
  };
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-150 overflow-y-auto flex items-center justify-center p-2 sm:p-4 md:p-6" id="pdf-modal-viewport">
        ...
        >
          ...
          <div className="bg-bark-900 border-b border-bark-800 text-sand-50 px-3 sm:px-4 py-2 flex flex-col sm:flex-row items-center justify-between gap-3 flex-shrink-0" id="pdf-toolbar">
            ...
            <div className="flex items-center gap-2 sm:gap-4 flex-wrap sm:flex-nowrap" id="pdf-middle-actions">
              ...
              <div className="hidden lg:flex items-center bg-bark-800/80 border border-bark-750 p-0.5 rounded" id="pdf-layout-controls">
                ...
                <button
                  ...
                  className={`p-1.5 rounded transition-colors cursor-pointer ${isDualPage ? 'bg-clay-605 text-white font-bold' : 'text-sand-300 hover:bg-bark-700'}`}
                  title="Side-by-Side Dual Page View"
                >
            ...
            <div className="flex items-center gap-2" id="pdf-right-actions">
              ...
              >
                ...
                <span className="hidden sm:inline">Print Specimen</span>
              </button>
          ...
          <AnimatePresence>
            {isDownloading && (
              ...
              >
                ...
                <p className="text-sm font-mono font-bold tracking-wider">COMPILING PDF BLUEPRINT VECTOR METADATA...</p>
                <p className="text-[10px] text-bark-400 font-mono">Generating high-fidelity 2-page print layout package...</p>
              </motion.div>
            )}
            ...
            {isPrinting && (
              ...
              >
                ...
                <p className="text-sm font-mono font-bold tracking-wider">PREPARING ATELIER SPOOL DIALOGUE...</p>
                <p className="text-[10px] text-bark-400 font-mono">Formatting vector sheets to active page scale...</p>
              </motion.div>
            )}
            ...
            {printSuccess && (
              ...
              >
                ...
                <span>Sent 2 vector pattern sheets directly to your default system spooler!</span>
              </motion.div>
            )}
          </AnimatePresence>
                ...
                >
                  ...
                  <div className="space-y-4" id="p1-header">
                    <div className="flex justify-between items-start border-b-2 border-bark-900 pb-3">
                      <div>
                        <span className="text-[9px] font-mono tracking-[0.25em] font-extrabold text-clay-605 block">
                          PERFECT FIT BUREAU • PATTERN BLUEPRINT SYSTEM
                        </span>
                    ...
                    <div className="grid grid-cols-12 gap-6 pt-2">
                      ...
                      <div className="col-span-4 bg-sand-50/50 border border-sand-200 p-3 rounded space-y-1.5 text-[10px] font-mono">
                        <div>
                          <span className="text-bark-400 uppercase tracking-wider block text-[8px]">DIFFICULTY:</span>
                        ...
                        <div className="border-t border-sand-200/60 pt-1.5">
                          <span className="text-bark-400 uppercase tracking-wider block text-[8px]">EST. CONSTRUCTION:</span>
                      ...
                      <div className="col-span-5 space-y-2">
                        ...
                        <div className="space-y-1.5 bg-sand-50/30 p-2.5 rounded border border-sand-200/60">
                          ...
                          <div className="border-t border-sand-200/50 pt-1.5 mt-2 text-[10.5px] text-bark-800">
                            <b>Fabric Width Required:</b> 60" ({pattern.yardageInfo.width60}) or 44" ({pattern.yardageInfo.width44 || '3.5 Yards'})
                          </div>
                        </div>

                        {/* List of notions */}
                        <div className="pt-1">
                          <h4 className="text-[10px] font-mono font-bold uppercase tracking-widest text-bark-500 mb-1">
                            Required Notions
                          </h4>
                          ...
                          <table className="w-full text-left border-collapse text-[10px] font-sans">
                            <thead>
                              <tr className="bg-bark-900 text-sand-100 font-mono text-[9px] font-bold uppercase">
                                <th className="p-1.5 border-b border-bark-800">Size</th>
                                <th className="p-1.5 border-b border-bark-800">Bust</th>
                                <th className="p-1.5 border-b border-bark-800">Waist</th>
                                <th className="p-1.5 border-b border-bark-800">Hips</th>
                                <th className="p-1.5 border-b border-bark-800 text-right">Yardage</th>
                              </tr>
                            </thead>
                  ...
                  <div className="space-y-3 mt-6" id="p1-diagram">
                    ...
                    <div className="border border-clay-500/25 rounded-lg p-4 bg-[#FAF9F6] relative overflow-hidden flex flex-col justify-between h-48 shadow-3xs">
                      ...
                      <div className="relative w-full h-full mt-2.5" id="fabric-blueprint-lay">
                        {/* Selvage indicators */}
                        <div className="absolute top-0 right-0 text-[6.5px] font-mono text-[#ba6446]/40 uppercase tracking-widest font-extrabold rotate-90 origin-right mr-1">
                          Selvage Edge
                        </div>
                  ...
                  <div className="border-t border-sand-200 pt-3 flex justify-between items-center text-[8.5px] font-mono text-bark-400 mt-8" id="p1-footer">
                    <span>PERFECT FIT BUREAU COUTURE SYSTEMS</span>
                    <span className="font-bold text-clay-605">DESIGNER SAMPLE ONLY • NOT FOR REPRODUCTION</span>
                  ...
                  <div className="space-y-4" id="p2-header">
                    <div className="flex justify-between items-start border-b-2 border-bark-900 pb-3">
                      <div>
                        ...
                        <p className="text-[10px] font-mono text-bark-500 mt-1 uppercase tracking-wider">
                          DETAILED ASSEMBLY INSTRUCTION BOOKLET • SPECIMEN EDITION
                        </p>
                      </div>
                      <div className="text-right flex flex-col items-end">
                        <div className="border border-bark-950 px-3 py-1 font-mono text-[10px] font-bold tracking-widest text-bark-900 uppercase">
                  ...
                  <div className="space-y-4 mt-6 flex-grow" id="p2-steps">
                    ...
                    <div className="space-y-4">
                      {[
                        {
                          num: '01',
                          title: 'STABILIZATION & PIECE PREPARATION',
                          desc: 'Apply fine weft interfacing to all facing pieces, collars, or waistband elements. Run a fine stay-stitch (stitch length 1.5mm) 1/8 inch within the seam allowance of all curves, especially collars and armholes, to prevent stretching.'
                        },
                        {
                          num: '02',
                          title: 'SHAPING CORDS, DARTS, AND SEWING TIES',
                          desc: 'Mark all darts precisely on the wrong side of the fabric using tailor\'s chalk. Stitch darts from the wide edge toward the point, leaving long threads at the tip. Tie threads by hand to prevent puckering. Press all bust/waist darts downward or toward the center line.'
                        },
                        {
                          num: '03',
                          title: 'COUTURE FLAT FRENCH SEAM JOINING',
                          desc: 'With wrong sides of the front and back panels facing, stitch the side and shoulder seams at 1/4 inch. Trim the seam allowance down to an even 1/8 inch. Press seam flat to set the stitches, then open. Turn fabric right sides together, crease sharply along the seam line, and stitch at 3/8 inch. This securely encases the raw edges inside.'
                        },
                        {
                          num: '04',
                          title: 'FACINGS, WRAP FASTENERS & ATTACHING COLLARS',
                          desc: 'Sew facing segments together at the shoulders. Pin facings to the bodice edges, matching collar markers and shoulder seams. Stitch using a consistent 3/8 inch seam allowance. Clip curves, grade allowances to reduce bulk, turn facings inside and understitch 1/16 inch from seam.'
                        },
                        {
                          num: '05',
                          title: 'BABY HEMMING & COUTURE CLAPPER FINISH',
                          desc: 'To hem delicate silks or linens beautifully, turn raw hem up by 1/4 inch and press. Stitch close to the edge. Trim excess allowance down to the stitching. Turn up again 1/8 inch to completely enclose raw edge, press and stitch again. Finish with a heavy wood clapper and high steam.'
                        }
                      ].map((step, idx) => (
                      ...
                      {pattern.tutorial?.tips?.map((tip, idx) => (
                        ...
                        <>
                          <li className="flex items-start gap-1.5">
                            <span className="text-amber-700 mt-0.5">•</span>
                            <span>Always stitch sample seam scraps before assembly to tune tension for delicate fibers.</span>
                          </li>
                          <li className="flex items-start gap-1.5">
                            <span className="text-amber-700 mt-0.5">•</span>
                            <span>A wooden clapper locks raw tailoring folds infinitely better than iron pressure alone.</span>
                          </li>
                        </>
                      )}
                    </ul>
          ...
          <div className="bg-sand-200 border-t border-sand-250/70 text-bark-600 px-4 py-2 flex items-center justify-between text-[10px] font-mono flex-shrink-0" id="pdf-footer-utility">
            <span className="flex items-center gap-1">
              ...
              <span>Full instruction booklets contain 12 additional sizing schematics and direct CAD files.</span>
            </span>
            <span>
              Specimen ID: <span className="font-bold text-bark-900">{pattern.id}</span>
            </span>
          </div>
